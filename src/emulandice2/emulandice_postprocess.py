...
def write_localized_projections(
    rsl,
    site_ids,
    site_lats,
    site_lons,
    ...
    ncvar_attributes = {
        "description": "Local SLR contributions according to emulandice2",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="grd_fingerprintmap.yml",
    )
